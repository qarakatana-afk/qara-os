# Decision Record: SCN-003 / RUN-017
...
- Stage 4: Evaluated the proposal against v0.1 scope boundaries in MVP_v0.1.md.
- Stage 5: Confirmed the proposed capability introduces functionality not included in the approved scope.
- Stage 6: Conflict with approved scope confirmed; governance authorization required before approval.
...
- Trace Log: TRACE_LOGS/SCN-003/TRACE-SCN-003-RUN-017.md
- Related Run Log Entry: RUN_LOG.md (RUN-017)
- Equivalence Matrix Reference: EQUIVALENCE_MATRIX.md (SCN-003 comparisons)

## Notes
Canonical fixed-input run 3 of 4 under SCN-003-INPUT-v1.0. Five-run equivalence set includes RUN-005 (pre-canonical, markdown input).
