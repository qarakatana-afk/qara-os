...
The responsible steward shall issue one of the formal review outcomes defined in Section 7.
...
8. Issue one formal review outcome.
...
The recommended identifier format is KRR-YYYY-NNN.
...
An artificial intelligence agent may detect escalation triggers, prepare an escalation request, summarize evidence and conflict, identify relevant specifications, compare available options, and draft a review record.
...
Where this specification conflicts with QS-007, QS-008, or QS-009, those specifications control Kernel purpose, execution, and durable decision records within their defined scope.
...
- [ ] Level One uses the formal review outcomes in Section 7.
- [ ] Review outcomes are unambiguous and remain separate from Kernel Decisions.
